...
public class SPUtils
{
    ...
    public static void setObject(Context mContext, String fileName, String key, Object object) {
    ...
    public static  <T> T getObject(Context mContext, String fileName, String key) {
        SharedPreferences sp = mContext.getSharedPreferences(fileName, Context.MODE_PRIVATE);
        if (sp.contains(key)) {
